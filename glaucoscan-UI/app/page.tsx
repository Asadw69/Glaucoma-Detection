...
export default function Home() {
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      const apiUrl = process.env.NEXT_PUBLIC_GLAUCOMA_API_URL || "http://localhost:8236";
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-[#0a192f] to-[#112240] py-12 px-4">
        ...
        <div className="space-y-8 max-w-2xl w-full mx-auto px-4 sm:px-6 lg:px-0">
          ...
          <div className="relative">
            ...
            >
              {selectedImage ? (
                <div
                  className={`relative w-full h-full ${result?.prediction === 'Glaucoma'
                    ? 'ring-4 ring-red-500'
                    : result
          ...
          <div className="bg-[#1a2942] p-8 rounded-2xl space-y-6 max-w-md w-full mx-auto">
            ...
            {isAnalyzing ? (
              ...
              <div className="space-y-4">
                <div className={`p-4 rounded-lg ${result.prediction === 'Glaucoma'
      ...
      <div className="text-sm text-center text-gray-400 px-4 pt-12 max-w-3xl mx-auto">
        Glaucare is intended for educational and research demonstration purposes only. It is not a substitute for professional medical diagnosis or advice.
      </div>
    </main>
  );
}
